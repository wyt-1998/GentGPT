...
namespace OpenAI_API.Images
{
    ...
    public class ImageSize
    {
        ...
        /// </summary>
        public static ImageSize _256
        { get { return new ImageSize("256x256"); } }

        /// <summary>
        /// Requests an image that is 512x512
        /// </summary>
        public static ImageSize _512
        { get { return new ImageSize("512x512"); } }

        /// <summary>
        /// Requests and image that is 1024x1024
        /// </summary>
        public static ImageSize _1024
        { get { return new ImageSize("1024x1024"); } }
